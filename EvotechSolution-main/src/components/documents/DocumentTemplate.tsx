...
interface DocumentTemplateProps {
  type: 'invoice' | 'estimate' | 'delivery_note' | 'purchase_order';
  documentId: string;
  date: string;
  client?: string;
  supplier?: string;
...
export const DocumentTemplate: React.FC<DocumentTemplateProps> = ({
  ...
  const showVAT = type === 'invoice' || type === 'estimate';
  
  // Use full contact data if available, otherwise fall back to name string
  const contactData = type === 'purchase_order' ? supplierData : clientData;
