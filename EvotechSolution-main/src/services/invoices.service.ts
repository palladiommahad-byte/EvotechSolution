...
export const invoicesService = {
  ...
  async create(invoice: {
    ...
    try {
      ...
      const { data: newInvoice, error: invoiceError } = await supabase
        ...
        check_number: invoice.payment_method === 'check' ? (invoice.check_number || null) : null,
          status: 'draft',
  ...
  async update(id: string, invoice: {
    ...
    try {
      ...
      if (invoice.check_number !== undefined) updateData.check_number = invoice.payment_method === 'check' ? (invoice.check_number || null) : null;
